...
path: /reference/airnode/v0.11/understand/api-security.html
version: v0.11
outline: deep
tags:
---
...
- [Airnode Authentication](/reference/airnode/v0.11/concepts/airnode-auth.md)
...
- [apiKey](/reference/airnode/v0.11/understand/api-security.md#apikey)
- [http](/reference/airnode/v0.11/understand/api-security.md#http)
...
requesters using
[Authorizers](/reference/airnode/v0.11/understand/apply-auth.md) to access the
Airnode.

- [relayRequesterAddress](/reference/airnode/v0.11/understand/api-security.md#relayrequesteraddress)
- [relayChainId](/reference/airnode/v0.11/understand/api-security.md#relaychainid)
- [relayChainType](/reference/airnode/v0.11/understand/api-security.md#relaychaintype)
- [relaySponsorAddress](/reference/airnode/v0.11/understand/api-security.md#relaysponsoraddress)
- [relaySponsorWalletAddress](/reference/airnode/v0.11/understand/api-security.md#relaysponsorwalletaddress)
- [relayRequestId](/reference/airnode/v0.11/understand/api-security.md#relayrequestid)
...
the [requester](/reference/airnode/v0.11/concepts/requester.md) address.
...
[sponsor address](/reference/airnode/v0.11/concepts/sponsor.md#sponsoraddress).
...
forward the
[sponsor wallet address](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet).
...
[id of the request](/reference/airnode/v0.11/concepts/request.md#requestid).
...
[Airnode Authentication Security Schemes](/reference/airnode/v0.11/understand/api-security.md#airnode-authentication-security-schemes)
and
...
1. [Define the security schemes for an OIS](/reference/airnode/v0.11/understand/api-security.md#step-1-define-the-security-schemes-for-an-ois)
2. [Turn on the defined security schemes](/reference/airnode/v0.11/understand/api-security.md#step-2-turn-on-the-defined-security-schemes)
3. [Specify the values for the defined security schemes](/reference/airnode/v0.11/understand/api-security.md#step-3-specify-the-values-for-the-defined-security-schemes)
